        ...
        while epoch < epochs:
            ...
            if epoch % 1 ==0:
                ...
                for x_batch, y_batch in testloader_one:
                    ...
                    # print(x_batch.shape, tau.shape)
                    x_hat, y_hat, xvar, yvar, _ = self.forward(x_batch, 1)
                    ...
                    for i in range(5):
                        ...
                        yerr = (yvar.cpu().detach().numpy()[i, :]-Rhat)
                        ...
                        yerr = (xvar.cpu().detach().numpy()[i, :]-Ehat)
                        fill_up = Ehat+yerr
                        fill_down = Ehat-yerr
                        fill_down[fill_down<0]= 0
                    ...
                    break        
                fig.tight_layout()
                plt.savefig("sample_01/Rhat_One_"+str(epoch)+".png", dpi=300)
                plt.close()
                ...
                fig.tight_layout()
                plt.savefig("sample_01/Rhat_Two_"+str(epoch)+".png", dpi=300)
